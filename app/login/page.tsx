          ...
          <div className="p-6 md:p-8 lg:p-10">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <button
                ...
                disabled={loading}
                className="relative w-full group overflow-hidden rounded-lg shadow-md hover:shadow-lg transition-all duration-300"
              >
                <div className="relative flex items-center justify-center gap-3 bg-white py-3 md:py-3.5 px-4 rounded-lg font-medium text-gray-700 transition-all duration-300 hover:bg-gray-50">
                  {loading ? (
                    <>
            ...
            <div className="mt-4 text-center">
              <p className="text-[8px] md:text-[9px] text-gray-500">
                🔒 Secure login with your Google account • No password needed
              </p>
            </div>
          </div>
        </div>
